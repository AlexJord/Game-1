...
def game_ends(winner_name):
    print(f'{winner_name} won the game! Do thou dare to play again?')

while game_running == True:
    counter = 0
    new_round = True
    player = {'name': 'Alex', 'attack': 13, 'heal': 16, 'health': 100}
    monster = {'name': 'Brian', 'attack_min': 10, 'attack_max': 20, 'health': 100}
    
    
    print('---' * 7)
    player['name'] = input("You dare to challenge the monster who hast brought danger upon us? Well then... enter your name here champion! ")
